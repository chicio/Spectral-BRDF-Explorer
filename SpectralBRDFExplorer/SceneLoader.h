...
namespace SceneLoader {
    ...
    void loadRGBScene() {
            ...
            Model3D model3D0(OpenGLESConfiguration::modelFileBasePath, "Dragon");
            ...
            Model3D model3D1(OpenGLESConfiguration::modelFileBasePath, "HappyBuddha");
            ...
            Model3D model3D2(OpenGLESConfiguration::modelFileBasePath, "ThaiStatue");
            ...
            Model3D model3D4(OpenGLESConfiguration::modelFileBasePath, "Bunny");
            ...
            Model3D floor3D(OpenGLESConfiguration::modelFileBasePath, "Floor");
            ...
            floor3D.setMaterial(Material::createMatteMaterial());
            floor3D.lighting = "Lambertian";
            Scene::instance().models.push_back(floor3D);

            Model3D skybox(OpenGLESConfiguration::modelFileBasePath, "Cube");
