...
namespace SceneLoader {
    ...
    void loadRGBScene() {
        ...
        model3D0.setMaterial(RGBMaterial::createRubyMaterial());
        ...
        model3D2.setMaterial(RGBMaterial::createMatteMaterial());
        ...
        model3D3.setMaterial(RGBMaterial::createJadeMaterial());
        ...
        model3D4.setMaterial(RGBMaterial::createOrangeMaterial());
